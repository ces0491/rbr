...
If you have read about deploying Shiny apps anywhere else, you have read about **shinyapps.io**. It still works, but Posit is consolidating it into **[Posit Connect Cloud](https://connect.posit.cloud/)** and has published a timeline: a migration tool arrives in Connect Cloud in September 2026, and accounts that haven't migrated are moved automatically from early 2027. Existing URLs get permanent redirects, so links already shared keep working.
