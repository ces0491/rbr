...
The resources presented in this guide are largely freely available (except for the Cloud platforms which are free to setup but incur usage costs), so you can get started without any financial investment.
