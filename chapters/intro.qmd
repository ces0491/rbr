...
It is about setting up the tools, not about learning to code. There are excellent resources for the latter, several listed in the [References](references.qmd) chapter. This one assumes you can already write the analysis and focuses on everything that has to be true before you can run it.

## Does This Still Matter When a Model Can Write the Code?

It's a fair question, and it deserves a direct answer rather than a reassurance.
...
[Reproducible Environments](environments.qmd). Environment problems are the single largest source of wasted time for analysts who write code, and the fix takes an afternoon to learn and pays back for the rest of your career.
:::
