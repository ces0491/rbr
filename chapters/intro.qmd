...
Welcome to the world of data science! If you're coming from economics, statistics, engineering, or another technical field, you already have many of the analytical skills needed to excel. However, the technical infrastructure that supports modern data science work can seem overwhelming at first.
...
1.  **Many data science tools are designed to be used this way**: A Stack Overflow Developer Survey, about 70% of data scientists and developers regularly use command-line tools in their workflow [^1]. Tools like Git, Docker, and many Python/R package management utilities primarily use command-line interfaces.
...
According to surveys, Python has consistently ranked among the top programming languages, and a recent Kaggle Machine Learning & Data Science Survey found that 87% of data scientists use Python in their work [^2].
