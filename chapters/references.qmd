...
description: >-
  Books, courses and documentation for going deeper on the tools and concepts this book sets up.
---

## Resources for Further Learning

Some teach the coding this book leaves to others; the rest build on the infrastructure it sets up. Each entry says what it is for, so you can pick rather than work through the list.
...
1. **[Data Analysis at Scale in the Cloud](https://noahgift.github.io/cloud-data-analysis-at-scale/)** by Noah Gift  
   The course notes for Duke's MIDS programme, free online. Project-based, covering cloud foundations, ML engineering, and MLOps across AWS, GCP, and Azure.
