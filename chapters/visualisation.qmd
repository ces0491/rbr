...
The diagram above was generated by that code when this book was rendered — change the `steps` vector and the flowchart changes with it. That's the point: a diagram derived from data or configuration can't drift out of sync with the thing it documents, which hand-drawn diagrams invariably do.
