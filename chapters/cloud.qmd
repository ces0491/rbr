...
The ability to scale compute resources is particularly valuable for data scientists working with large datasets or computationally intensive models. Rather than investing in expensive hardware that might sit idle most of the time, cloud platforms let you rent a large machine for the afternoon you need it and shut it down afterwards.
...
The cloud buys you three things your laptop can't give you: hardware you don't own, storage that doesn't live on one disk, and a machine that keeps running when you close the lid.
