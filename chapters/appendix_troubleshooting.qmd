...
1. **Windows**:
   - Ensure Conda is properly initialised by running `conda init` in the Anaconda Prompt
...
1. **For conda**:
   ...
   - Create a fresh environment if existing one is corrupted: `conda create -n fresh_env python=3.12`
